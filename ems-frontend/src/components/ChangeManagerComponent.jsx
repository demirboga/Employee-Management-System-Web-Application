...
import {changeManager, getAllDepartments} from "../service/EmployeeService.js";
import {useNavigate} from "react-router-dom";


const ChangeManagerComponent=({ employees, onSelectEmployee, departmentId, modalId,refreshDepartments})=>{
    ...
    function handleManager() {
        if (manager) {
            changeManager(departmentId, manager)
                .then((response) => {
                    refreshDepartments(); // Re-fetch all departments
                })
...
export default ChangeManagerComponent;